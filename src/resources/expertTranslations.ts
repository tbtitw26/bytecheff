...
export function getTranslatedExpert(expert: Expert): Expert {
    const translations = expertTranslations[expert.id as keyof typeof expertTranslations];
    ...
    return {
        ...
        specialties: translations.specialties ? [...translations.specialties] : expert.specialties,
        profile: {
            ...expert.profile,
